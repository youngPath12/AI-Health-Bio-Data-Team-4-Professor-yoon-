...
Ridge 모델은 CN train의 실제 나이를 가장 잘 예측하도록 MRI ROI별 계수를 먼저 **학습**합니다. 이후 held-out CN test에서 permutation importance를 계산해, 학습이 끝난 모델의 나이 예측에 실제로 유용했던 ROI 정보를 평가했습니다.

따라서 아래 중요도는 모델 가중치를 조절하기 위해 사전에 준 값이 아닙니다. 한 ROI 값을 무작위로 섞었을 때 독립 CN test의 나이 예측 오차가 얼마나 증가하는지를 확인한 **사후 예측 기여도 평가**입니다. `MAE 증가`가 클수록 해당 ROI 정보가 정상군 실제 나이 예측에 더 유용했음을 뜻합니다.

| MRI ROI | 측정 요소 | 정상 노화에서 함께 관찰될 수 있는 방향 | 더 고령의 정상 뇌 구조 방향으로 읽는 예 | MAE 증가(년) |
|---|---|---|---|---:|
| 뇌간 | 부피 | 부피 감소 | 뇌간 부피가 작음 | 0.225 |
| 백질 고신호 | 백질 병변량 | 병변량 증가 | 백질 고신호량이 많음 | 0.204 |
| 제3뇌실 | 뇌실 부피 | 뇌실 확장 | 제3뇌실이 큼 | 0.164 |
| 좌측 transverse temporal | 회백질 부피 | 부피 감소 | 해당 영역 부피가 작음 | 0.109 |
| 우측 상측두엽 | 피질 두께 | 피질 얇아짐 | 피질 두께가 얇음 | 0.072 |
| 좌측 상측두엽 | 피질 두께 | 피질 얇아짐 | 피질 두께가 얇음 | 0.061 |
| 좌측 중측두엽 | 피질 두께 | 피질 얇아짐 | 피질 두께가 얇음 | 0.056 |
| 좌측 상전두엽 | 회백질 부피 | 부피 감소 | 부피가 작음 | 0.053 |
| 좌측 편도체 | 부피 | 부피 감소 | 편도체 부피가 작음 | 0.053 |
| 좌측 하두정엽 | 회백질 부피 | 부피 감소 | 부피가 작음 | 0.052 |
| 좌측 측좌핵 | 부피 | 부피 감소 | 측좌핵 부피가 작음 | 0.050 |
| 우측 상두정엽 | 피질 두께 | 피질 얇아짐 | 피질 두께가 얇음 | 0.050 |
| 좌측 상두정엽 | 회백질 부피 | 부피 감소 | 부피가 작음 | 0.047 |
| 좌측 해마 | 부피 | 부피 감소 | 해마 부피가 작음 | 0.043 |
| 시신경교차 | 부피 | 개인차·측정 변동 가능 | 단순한 생물학적 방향 해석은 주의 | 0.042 |

### 해석 원칙

일반적으로 피질 두께·해마·편도체·일부 회백질 부피가 작고, 뇌실 부피와 백질 고신호량이 큰 MRI 패턴은 더 고령의 정상 뇌 구조 방향과 함께 읽을 수 있습니다. 그러나 여러 ROI가 동시에 모델에 들어가므로, 한 ROI의 값만으로 개인의 뇌 나이를 판단할 수는 없습니다.

Ridge 계수는 표준화된 모든 ROI와 성별을 함께 고려한 조건부 예측 계수입니다. ROI들 사이에는 높은 상관이 있으므로, 계수나 중요도 하나만으로 특정 영역이 가장 중요하다거나 질병의 원인이라고 결론 내리지 않습니다. 이 프로젝트는 permutation importance를 **정상군 실제 나이 예측 기여도**, 해부학적 방향을 **정상 노화와 함께 읽는 보조 해석**으로 제시합니다.
